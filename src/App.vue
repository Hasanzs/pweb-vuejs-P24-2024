...
<template>
  <nav class="bg-wood p-7">
    <div class="container mx-auto flex justify-between items-center">
      <div class="flex items-center space-x-4">
        <h3 class="text-beige font-bold">Katalog Perpustakaan P24</h3>
      </div>
      <div class="md:hidden">
      ...
      <div class="hidden md:flex items-center space-x-4">
        <RouterLink to="/" class="text-white font-bold">Home</RouterLink>
        <RouterLink to="/add-book" class="text-beige font-bold">Add Book</RouterLink>
      </div>
    </div>
  </nav>
